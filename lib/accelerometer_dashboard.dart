...
class _AccelerometerDashboardState extends State<AccelerometerDashboard> {
  ...
  void _startMotionTimer() {
    ...
    _motionTimer = Timer(Duration(seconds: 2), () {
      ...
      _showNotification('Your device is in moving');
    });
  }
  ...
  void _stopMotionTimer() {
    ...
    _motionTimer = Timer(Duration(seconds: 10), () {
      // Trigger notification for stationary state
      _showNotification('your device is not moving');
    });
      ...
      child: Column(
        ...
        children: <Widget>[
          CircularPercentIndicator(
            ...
            progressColor: const Color.fromARGB(255, 117, 243, 33),
          ),
          SizedBox(height: 50),
          Row(
  ...
  Widget _buildSensorCard(String title, double value) {
    return Card(
      elevation: 4,
      color: Color.fromARGB(255, 162, 181, 93), // Set card color to transparent
      child: Padding(
