        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            if (_accelerometerValues.isNotEmpty)
              Text(
                'X: ${_accelerometerValues[0].x.toStringAsFixed(1)}, '
                    'Y: ${_accelerometerValues[0].y.toStringAsFixed(1)}, '
                    'Z: ${_accelerometerValues[0].z.toStringAsFixed(1)}',
                style: TextStyle(fontSize: 16),
              )
            else
              Text('There is no data', style: TextStyle(fontSize: 16)),
          ],
        ),
      ),
    );
